...
const cardsIcon = require('./images/myCards.png'); 
const statisticsIcon = require('./images/statictics.png'); 
      ...
      <View style={styles.header}>
        <View style={styles.profileContainer}>
          ...
          <View>
            ...
            <Text style={[styles.text, styles.boldText, isDarkMode && styles.darkText]}>Eric Atsu</Text>
          </View>
        </View>
